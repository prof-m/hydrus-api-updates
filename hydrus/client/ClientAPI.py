...
CLIENT_API_PERMISSION_MANAGE_TAG_RELATIONSHIPS = 14
...
ALLOWED_PERMISSIONS = (
    ...
    CLIENT_API_PERMISSION_MANAGE_TAG_RELATIONSHIPS
)
...
basic_permission_to_str_lookup = {
    ...
    CLIENT_API_PERMISSION_MANAGE_TAG_RELATIONSHIPS : 'edit tag siblings/parents'
}
